...
const std::string CSettings::SETTING_AMLOGIC_GPUCLOCK = "amlogic.gpuclock";
const std::string CSettings::SETTING_AMLOGIC_COLORSPACE = "amlogic.colorspace";
const std::string CSettings::SETTING_AMLOGIC_FORCERGB = "amlogic.forcergb";
const std::string CSettings::SETTING_AMLOGIC_DIPOSTPROCESSING = "amlogic.dipostprocessing";
const std::string CSettings::SETTING_AMLOGIC_MUTEHDMIAUDIO = "amlogic.mutehdmiaudio";
